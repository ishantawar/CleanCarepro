...
const config = {
  ...
  RATE_LIMIT: {
    ...
    MAX_REQUESTS: config.NODE_ENV === "development" ? 1000 : 100, // More generous in development
    AUTH_WINDOW_MS: 5 * 60 * 1000, // 5 minutes
    AUTH_MAX_REQUESTS: config.NODE_ENV === "development" ? 50 : 10, // More generous in development
  },
